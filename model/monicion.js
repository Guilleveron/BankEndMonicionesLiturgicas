module.exports={
    ...
    insertar:function(conexion,datos,funcion){
        conexion.query("INSERT INTO moniciones (titulo, ciclo, tiempo, entrada, lecturas, respuestaOracionUniversal, oracionUniversal1, oracionUniversal2, oracionUniversal3, oracionUniversal4, oracionUniversal5, presentacionDeLasOfrendas, comunion, despedida) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [datos.titulo, datos.ciclo, datos.tiempo, datos.entrada, datos.lecturas, datos.respuestaOracionUniversal, datos.oracionUniversal1, datos.oracionUniversal2, datos.oracionUniversal3, datos.oracionUniversal4, datos.oracionUniversal5, datos.presentacionDeLasOfrendas, datos.comunion, datos.despedida], funcion);
    },
    ...
    actualizar:function(conexion,datos,funcion){
        conexion.query("UPDATE moniciones SET titulo=?, ciclo=?, tiempo=?, entrada=?, lecturas=?, respuestaOracionUniversal=?, oracionUniversal1=?, oracionUniversal2=?, oracionUniversal3=?, oracionUniversal4=?, oracionUniversal5=?, presentacionDeLasOfrendas=?, comunion=?, despedida=? WHERE id=? ",[datos.titulo, datos.ciclo, datos.tiempo, datos.entrada, datos.lecturas, datos.respuestaOracionUniversal, datos.oracionUniversal1, datos.oracionUniversal2, datos.oracionUniversal3, datos.oracionUniversal4, datos.oracionUniversal5, datos.presentacionDeLasOfrendas, datos.comunion, datos.despedida, datos.id],funcion);
    }
}